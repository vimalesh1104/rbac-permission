    ...
    ***************************************************************************** */
    ...
    var PermissionsComponent = /** @class */ (function () {
        ...
        PermissionsComponent.prototype.searchDynamicPageList = function (event) {
            var value = event.target.value.toLowerCase();
            this.pagesList = this.duplicateDynamicPagesList.filter(function (a) { var _a; return (_a = a === null || a === void 0 ? void 0 : a.value) === null || _a === void 0 ? void 0 : _a.toLowerCase().startsWith(value); });
        };
        PermissionsComponent.prototype.searchPlatformPageList = function (event) {
            var value = event.target.value.toLowerCase();
            this.pagesList = this.duplicatePlatformPagesList.filter(function (a) { var _a; return (_a = a === null || a === void 0 ? void 0 : a.pagename) === null || _a === void 0 ? void 0 : _a.toLowerCase().startsWith(value); });
        };
